...
void expand(std::priority_queue<State, std::vector<State>, struct cmp> &pq, std::set<std::vector<std::vector<int>>> &visited, State curr);
void path(State s);
...
int main(int argc, char *argv[])
{
    ...
    std::priority_queue<State, std::vector<State>, struct cmp> pq;
